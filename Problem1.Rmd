...
source('./problem1scripts.R')
# tuning_curves1 = createTuningCurveDataFrame(data)1
...
```{r}
data2 = importData('./Mouse12-120807/Mouse12-120807', 12)
```
...
```{r}
data3 = importData('./Mouse12-120808/Mouse12-120808', 12)
```

```{r}
tuning_curves3 = createTuningCurveDataFrame(data3)
ggplot(data=tuning_curves3) + geom_line(aes(x=angle_bins, y=firing_rate, color=cell)) + facet_wrap( ~ tetrode, ncol=4, scale='free_y')
```